...
char auth[] = "KSmJPGWY5gfIZ8OFzaOQbJpN-uN-9yWo";   // маркер автентифікації
char ssid[] = "Net";                                // назва мережі Wi-Fi (2.4 Ghz)
char pass[] = "5f74TWn28x5Y4k7Aw";                  // пароль від мережі Wi-Fi
// ------------------------------------------------
